...
export class SendSearchFormComponent {
  ...
  model = new SendSearchRequest(this.authService.savedSearchInfo.from, this.authService.savedSearchInfo.to, this.authService.savedSearchInfo.by, '', '', '', '');
  submitted = false;
  message;
  selectedTransfer;
  ...
  onSubmit() {
    ...
    this.submitted = true;
    console.log(this.model.by);
    this.authService.savedSearchInfo.from = this.model.from;
    this.authService.savedSearchInfo.to = this.model.to;
    this.authService.savedSearchInfo.by = this.model.by;
